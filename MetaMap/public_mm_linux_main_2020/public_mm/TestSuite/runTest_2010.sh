...
NegEx_XML|-% format|--XMLf|NegEx, XML format|1|
WSD_off_1|||Without WSD 1|0|
WSD_off_2|||Without WSD 2|0|
WSD_on_1|-y|-y|With WSD 1|0|
WSD_on_2|-y|-y|With WSD 2|0|
XML_format1|-% format1|--XMLf1|XML Format1|1|
XML_format|-% format|--XMLf|XML format|1|
XML_noformat1|-% noformat1|--XMLn1|XML noformat1|1|
XML_noformat|-% noformat|--XMLn|XML noformat|1|
...
prefer_multiple_concepts|-Y|-Y|Prefer Multiple Concepts|0|
quick_composite_phrases|-Q|-Q|Quick Composite Phrases|0|
restrict_to_sources_XML|-R MSH -% format|-R MSH --XMLf|Restrict to Sources, XML format|1|
