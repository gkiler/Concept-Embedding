...
public class Tagger
{
    ...
    **/
	...
	// System.out.format("tagText inDoc is \"" + inDoc + "\"\n");
    ...
    **/
                 ...
                 boolean useSpecialistTags)
    {
      ...
      // System.out.format("tagTextSyn inDoc is \"" + inDoc + "\"\n");
        StringBuffer result = new StringBuffer();
    ...
    **/
    ...
    private String processText(String inText)
    {
        ...
        while(i < len)
        {
	     ...
	     // System.out.format("YES|%d|%c|%d\n", i, ch, Character.getNumericValue((int)ch));
