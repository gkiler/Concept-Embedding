...
BASE_URL = 'https://www.seattlechildrens.org/conditions/a-z/'
SOURCE_NAME = 'Seattle Childrens'
HREF_BASE = 'https://www.seattlechildrens.org'
if __name__ == '__main__':
    ...
    links = []
    links.extend(ScrapingFramework.links_from_containers_html(driver.page_source,'ul','vlist no-bullets body-medium'))
