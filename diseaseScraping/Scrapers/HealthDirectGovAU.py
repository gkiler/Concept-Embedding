...
SOURCE_NAME = "HealthDirectGovAU"
BASE_URL ='https://www.healthdirect.gov.au/health-topics/conditions'
HREF_BASE = 'https://www.healthdirect.gov.au'
...
if __name__ == '__main__':
    ...
    driver.get(BASE_URL)
    links = []
    links.extend(ScrapingFramework.links_from_containers_html(driver.page_source,'ul','article_lists-column'))
