...
BASE_URL = 'https://medlineplus.gov/all_healthtopics.html'
HREF_BASE = ''
...
if __name__ == '__main__':
    ...
    links.extend(ScrapingFramework.links_from_containers_html(driver.page_source,'li','item'))
    links.extend(ScrapingFramework.links_from_containers_html(driver.page_source,'li','item break'))
